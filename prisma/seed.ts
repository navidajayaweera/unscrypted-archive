  ...
  await prisma.knowledge.createMany({
    data: [
      ...
      },
      {
        ...
        description: "Extraction and preparation of penicillin from bread mould cultures using salvaged lab equipment. Includes dosage guidelines and contraindication list.",
        filePath: "/uploads/improvised-antibiotics.txt",
        tags: "medical,survival",
      },
      {
        title: "Solar Panel Array Wiring Guide",
        description: "Series vs parallel configurations for 12 V and 24 V systems. Charge controller sizing, battery bank calculations, and inverter selection.",
        filePath: "/uploads/solar-array-wiring.txt",
        tags: "engineering,tech",
      },
      {
        title: "Seed Vault Preservation Handbook",
        description: "Long-term seed storage using airtight containers, silica gel desiccants, and cool dark vaults. Germination testing schedules and variety priority list.",
        filePath: "/uploads/seed-vault-preservation.txt",
        tags: "agricultural,farming,survival",
      },
      {
        title: "Structural Integrity Assessment",
        description: "Visual inspection checklist for post-event buildings. Crack classification, load-bearing wall identification, and safe demolition of collapse-risk sections.",
        filePath: "/uploads/structural-integrity.txt",
        tags: "engineering,construction",
      },
      {
        title: "LoRa Mesh Network Deployment",
        description: "Setting up 915 MHz LoRa mesh nodes for sector-to-sector comms. Node placement, antenna gain tables, and frequency hopping to avoid interception.",
        filePath: "/uploads/lora-mesh-deployment.txt",
        tags: "tech,engineering",
      },
      {
        title: "Wound Closure Without Sutures",
        description: "Steri-strip and butterfly closure techniques for field lacerations. Wound irrigation standards, infection watch protocol, and dressing change schedule.",
        filePath: "/uploads/wound-closure-field.txt",
        tags: "medical,first-aid",
      },
      {
        title: "Underground Ventilation Design",
        description: "Passive and powered airflow systems for bunkers. Carbon dioxide build-up thresholds, fan sizing, and NBC filter maintenance intervals.",
        filePath: "/uploads/underground-ventilation.txt",
        tags: "engineering,construction",
      },
      {
        title: "Composting in Enclosed Spaces",
        description: "Vermicomposting and bokashi methods adapted for sealed bunker grow-rooms. Odour control, harvest timing, and nutrient content benchmarks.",
        filePath: "/uploads/bunker-composting.txt",
        tags: "agricultural,farming",
      },
      {
        title: "Water Well Drilling Manual",
        description: "Hand-auger and percussion drilling techniques for reaching shallow aquifers. Casing installation, grout sealing, and bacteriological testing with field kits.",
        filePath: "/uploads/water-well-drilling.txt",
        tags: "engineering,survival",
      },
      {
        title: "Radiation Exposure & Decontamination",
        description: "Dose thresholds, shelter-in-place protocols, and decontamination shower procedures. KI tablet dosage chart and fallout decay rate reference table.",
        filePath: "/uploads/radiation-decontamination.txt",
        tags: "medical,survival",
      },
      {
        title: "Blacksmithing Fundamentals",
        description: "Setting up a forge from salvaged components. Coal vs charcoal fuel, quenching techniques for tool steel, and priority tool fabrication list.",
        filePath: "/uploads/blacksmithing-fundamentals.txt",
        tags: "engineering,construction",
      },
      {
        title: "Archive Data Backup Protocol",
        description: "Procedures for maintaining redundant offline copies of Archive data. Verified storage media types, checksumming, and physical distribution across sectors.",
        filePath: "/uploads/archive-backup-protocol.txt",
        tags: "tech,engineering",
      },
      {
        title: "Perimeter Alarm Systems",
        description: "Tripwire, pressure-plate, and passive IR alarm designs using salvaged electronics. Zone mapping, watch rotation integration, and false-positive reduction.",
        filePath: "/uploads/perimeter-alarm-systems.txt",
        tags: "defense,engineering",
      },
      {
        title: "Medicinal Plant Index — Southern Region",
        description: "Identification and preparation of locally available medicinal plants. Covers anti-infective, analgesic, and wound-healing species with dosage notes.",
        filePath: "/uploads/medicinal-plants-south.txt",
        tags: "medical,survival,agricultural",
      },
      {
        title: "Food Ration Calculation Tables",
        description: "Daily caloric and macronutrient requirements by activity level. Ration allocation formulas for group sizes of 10–500, including children and injured.",
        filePath: "/uploads/food-ration-tables.txt",
